    ...
    <div class="container-lg">
      <div class="row justify-content-center">
        ...
        <div class="col-md-6 text-center">
          <img src="assets/plate.png" alt="plate of food" class="img-fluid" />
        </div>
      </div>
      ...
      <div class="container mt-4 col-md-4">
        <form class="d-flex" action="" method="post">
          ...
          <button class="btn btn-light" type="submit" name='button'>Search</button>
        </form>
      </div>
        ...
        <div class="container mt-4">
          <div class="row">
            ...
            if (isset($_POST['button'])) {
              $search = $_POST['s'];
              // $sql1 = mysqli_query($conn, "SELECT ItemName FROM fooditem WHERE ItemName = '$search' ");
              $sql2 = mysqli_query($conn, "SELECT ItemName,ItemImage,Description,Price  FROM fooditem WHERE ItemName LIKE '%$search%' ");
            ...
            ?>
                ...
                <div class="col-md-4 mt-4">
                  <div class="card">
                    <img src="<?php echo $arr[1]; ?>" class="card-img-top" alt="Food Item Image" style=" height: 210px; width: 210px;">
                    <div class="card-body">
                      <h5 class="card-title"><?php echo $arr[0]; ?></h5>
                      <p class="card-text"><?php echo $arr[2]; ?></p>
                      <h6 class="card-title">$ <?php echo $arr[3]; ?></h6>
      ...
      <div class="row justify-content-center my-5">
        <div class="col-lg-6">
          <form>
            ...
            <div class="mb-3">
              <label for="exampleInputPassword1" class="form-label">Quection</label>
